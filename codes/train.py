...
def cal_metric(val_loader, val_ds_name, model, opt, current_step):
    ...
    avg_lr_psnr_y = sum(avg_lr_psnr_y) / len(avg_lr_psnr_y)
...
def main():
    ...
    opt["train"]["log_dir"] = opt['path']['log']
    if seed is None:
